  ...
  <div>
    ...
    >
      ...
      >
        ...
        <el-form-item label="通道的名称" prop="channelName">
          <el-input v-model="addeForm.channelName"></el-input>
        </el-form-item>
    ...
    >
      ...
      >
        <!-- ref:引用，指向本身，用于使用自身的方法 -->
        <el-form-item label="通道的名称" prop="channelName">
          <el-input v-model="editForm.warningName"></el-input>
        </el-form-item>
        <el-form-item label="单位" prop="unit">
...
export default {
  ...
  methods: {
    ...
    async showEditDialog(id) {
      console.log(id)
      const { data: res } = await this.$http.get('/warning/' + id)
      if (res.code !== 20000) {
    ...
    async removewarningById(id) {
      ...
      const { data: res } = await this.$http.delete('/warning/' + id)
      if (res.code !== 20000) {
